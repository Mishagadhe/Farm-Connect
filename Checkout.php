...
if (isset($_POST['place_order'])) {
    ...
    foreach ($_SESSION['cart'] as $crop_id => $quantity) {
        ...
        $sql_order = "INSERT INTO orders (email, fullname, cropid, cropname, quantity, order_date, street, district, mandal, state) VALUES ('$user_email', '$username', '$crop_id', '$crop_name', '$quantity', '$order_date', '$street', '$district', '$mandal', '$state')";
