...
// Start the session at the very beginning of the file
    ...
    if(isset($_POST["submit"])) {
        ...
        if (empty($errors)) {
            ...
            $query = "INSERT INTO agrregister VALUES ('$Fullname1', '$password1','$confirmpassword1','$email1', $phoneno1, '$aadhar1', '$state1', '$district1', '$mandal1', '$street1')";
            $result = mysqli_query($conn, $query);
            
            if ($result) { 
                header("Location: agri.html");
...
<head>
    ...
    <title>వ్యవసాయ అధికారి నమోదు</title>
    <style>
        body {
