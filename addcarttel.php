...
if ($result && $result->num_rows > 0) {
    ...
    echo "ఈ ఇమెయిల్‌తో ఎంపిక చేయబడిన వ్యక్తి లేదు.";
    exit();
}
...
<header>
        ...
        <h3>బొమ్మ చేసి. కనెక్ట్ అవ్వండి. పెద్దగా ఉండండి</h3>
    </header>
    <h2>అందుబాటులో రెక్కలు</h2>
    <div class="crop-container">
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo "<img src='".$row['image']."' alt='రెక్క చిత్రం'>";
                ...
                echo "<button type='submit' name='add_to_cart'>కార్ట్‌కు జోడించు</button>";
                echo "</form>";
                echo "</div>";
            }
        } else {
            echo "ఏ రెక్కలు అందుబాటులో ఉన్నాయో లేదో";
        }

        mysqli_close($conn);
        ?>
        </div>
        <button class="checkout-button" onclick="window.location.href='checkouttel.php'">చెక్ అవుట్</button>
