        ...
        <div class="login-container">
            ...
            <div>
                <select name="user_type" class="login-input">
                    ...
                    <option value="selection_officer">Selection Officer</option>
                    <option value="truck_driver">Truck Driver</option>
                </select>
            </div>
            <div>
                <input type="text" name="gmail" value="" class="login-input" placeholder="Gmail">
            </div>
            <div>
                <input type="password" name="pwd" value="" class="login-input" placeholder="Password">
            </div>
            <div>
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    switch ($user_type) {
        case 'admin':
            ...
            $redirect_url = "adminhomepage.php";
            break;
        case 'farmer':
            $sql = "SELECT * FROM farmer WHERE email = ? AND password = ?";
            $redirect_url = "farmerhomepage.php";
            break;
        ...
        case 'truck_driver':
            ...
            $redirect_url = "truckdriverhomepage.php";
            break;
        default:
            exit; // Exit script
    }
