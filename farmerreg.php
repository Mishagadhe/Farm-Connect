...
// Start the session at the very beginning of the file
    ...
    if(isset($_POST["submit"])) {
        ...
        if (empty($errors)) {
            ...
            $query = "INSERT INTO farmer VALUES ('$Fullname1', '$password1','$confirmpassword1','$email1', $phoneno1, '$aadhar1', '$state1', '$district1', '$mandal1', '$street1')";
            $result = mysqli_query($conn, $query);
            
            if ($result) {
                // Registration successful, display success message and redirect to Gmail login page
                echo "<p style='color: green;'>Registration successful!</p>";
                header("Location: gmaillogin.php");
                exit(); // Make sure to exit after displaying the message and setting up the redirect
            } else {
