...
<body>
    ...
    <header>
        <nav>
            <ul>
                <li><a href="fertilizers.php">Sample Seeds<br>Fertilizers</a></li>
                <li><a href="login_register.php">Create Account<br>Login</a></li>
                <li><a href="contact.php">Contact Us</a></li>
                <li><a href="InstructionEng.php">Guidance</a></li>
    ...
    <section id="agriculture-news">
        ...
        <ul class="news-list">
            <li>
                <a href="#">Agriculture News Title 1</a>
                <p>Agriculture news description goes here.</p>
            </li>
            <li>
                <a href="#">Agriculture News Title 2</a>
                <p>Agriculture news description goes here.</p>
            </li>
            <li>
                <a href="#">Agriculture News Title 3</a>
                <p>Agriculture news description goes here.</p>
            </li>
        </ul>
    </section>
    ...
    <!-- Footer -->
    <footer>
        <p>Contact us at: <a href="mailto:info@farmconnect.com">info@farmconnect.com</a></p>
        <p>&copy; 2024 Farm Connect</p>
    </footer>
