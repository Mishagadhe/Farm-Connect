...
// Start the session at the very beginning of the file
    ...
    if(isset($_POST["submit"])) {
        ...
        if (empty($errors)) {
            ...
            $query = "INSERT INTO truckdriver VALUES ('$Fullname1', '$password1','$confirmpassword1','$email1', $phoneno1, '$aadhar1', '$state1', '$district1', '$mandal1', '$street1','$vehicleno1','$licenseno1')";
...
<head>
    ...
    <title>ట్రక్ డ్రైవర్ నమోదు</title>
    <style>
        body {
...
<body>
    ...
    <div class="container">
        ...
        <label for="password">పాస్వర్డ్<span class="required">*</span>:</label>
    ...
    <div>
        <label for="confirmpassword">పాస్‌వర్డ్‌ని నిర్ధారించండి<span class="required">*</span>:</label>
        <input type="password" id="confirmpassword" name="Confirm_Password" required>
            ...
            <div>
                <label for="village">జిల్లా<span class="required">*</span>:</label>
                <input type="text" id="District" name="district" required>
            </div>
            <div>
                <label for="village">మండలం<span class="required">*</span>:</label>
            ...
            <div>
                <label for="vehicleno">వాహనం సంఖ్య<span class="required">*</span>:</label>
                <input type="text" id="vehicleno" name="vehicleno" required>
            </div>
            <div>
                <label for="licenseno">లైసెన్స్ సంఖ్య<span class="required">*</span>:</label>
