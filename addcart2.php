...
<header>
    ...
    <h2>Your selected crops to place order</h2>
    <div class="crop-container">
        <?php
        // Fetch crops from the database that are placed for quality check
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo "Quantity in quintals: <input type='number' name='quantity' value='1' min='0' step='0.01'><br><br>";
        ...
        <button class="checkout-button" onclick="window.location.href='Checkout2.php'">Checkout</button>
